...
public class GrupoProductos {
    ...
    public GrupoProductos(Long id_grupo, Long id_empresa, String nombre, String estado, Long usuario_creacion, Date fecha_creacion, Long usuario_actualizacion, Date fecha_actualizacion) {
