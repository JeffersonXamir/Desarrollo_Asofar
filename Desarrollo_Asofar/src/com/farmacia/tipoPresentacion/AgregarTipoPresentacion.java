 ...
 */
package com.farmacia.tipoPresentacion;

/**
 *
 * @author usuario
 */
public class AgregarTipoPresentacion extends javax.swing.JDialog {

    /**
     * Creates new form TipoPresentacion
     */
    public AgregarTipoPresentacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NUEVA PRESENTACION :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarTipoPresentacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarTipoPresentacion dialog = new AgregarTipoPresentacion(new javax.swing.JFrame(), true);
